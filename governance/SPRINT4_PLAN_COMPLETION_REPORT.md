...
- Sprint 4 in-repo implementation/evidence status: `GO` for Finance+Controls approvals and owned evidence artifacts.
- Remaining Sprint 4 in-repo partial item: integrated elimination/FX output coupling in multi-entity dry-run path (joint cross-squad ownership).
