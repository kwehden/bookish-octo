...
require_file "governance/sprint7_signoff_packet.md"
...
require_file "governance/SPRINT7_PLAN_COMPLETION_REPORT.md"
require_file "qa/SPRINT5_GATE_REPORT.md"
require_file "qa/SPRINT6_GATE_REPORT.md"
require_file "qa/SPRINT7_GATE_REPORT.md"
...
require_file "specs/SPRINT7_SQUAD_AGENT_EXECUTION_PLAN.md"
...
require_heading "governance/architect_updates.md" "## Update 9"
...
require_heading "finance/US_CA_FINANCE_EVIDENCE_CHECKLIST_V1.md" "## Sprint 7 Checklist"
...
require_heading "governance/SPRINT7_PLAN_COMPLETION_REPORT.md" "## Quantitative Completion Rubric"
